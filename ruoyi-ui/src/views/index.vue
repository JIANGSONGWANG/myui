  ...
  <div class="app-container home">
    <el-row :gutter="20">
      <el-col :sm="24" :lg="24">
        <blockquote class="text-warning" style="font-size: 14px">
          FII Test Engineer Digital System
          <br />
          <br />
          If you have any problems, please contact admin: Jason Wang
          <br />
          <br />
    ...
    <el-row :gutter="20">
      <el-col :sm="24" :lg="12" style="padding-left: 20px">
        <h2>FII Test Engineer Digital System</h2>
        <p>
          Welcome to FII TE Digital System. This system is used to manage and maintain TE work.
        </p>
        <p>
      ...
      <el-col :xs="24" :sm="24" :md="12" :lg="8">
        <el-card class="update-log">
          <div slot="header" class="clearfix">
            <span>TE Leadership and Contact Information</span>
          </div>
          <div class="body">
            <p>
              <i class="el-icon-chat-dot-round"></i> TE manager：Guang Yang
            </p>
            <p>
              <i class="el-icon-chat-dot-round"></i> Astoria TE Lead: Dana
            </p>
            <p>
              <i class="el-icon-chat-dot-round"></i> Conan TE Lead: Ken T.
            </p>
            <p>
              <i class="el-icon-chat-dot-round"></i> Xena TE Lead: Bernardo V.
            </p>
            <p>
              <i class="el-icon-chat-dot-round"></i> Indus TE Lead:Tom L.
            </p>
            <p>
              <i class="el-icon-chat-dot-round"></i> Anthena TE Lead:Luis S.
            </p>
          </div>
        </el-card>
      </el-col>
